...
looking at, repairs its own DOM selectors with a model when the site changes its
...
This page is everything the project does and how to use it, with no prior
knowledge assumed. Three companion documents go deeper:
...
Setup is in [docs/SCRAPER-STUDIO.md](docs/SCRAPER-STUDIO.md) — including the wording to
