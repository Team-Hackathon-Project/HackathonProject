...
**Looking for how to use it?** That is the [README](../README.md). This document
is the reasoning underneath: why each part works the way it does, the data
shapes, the security model, and what has actually been verified.
...
[docs/SCRAPER-STUDIO.md](SCRAPER-STUDIO.md).
...
![Suggested targets in the options page](demo/08-targets.png)
...
See [docs/DEMO.md](DEMO.md) for the screenshots and the demo script.
